...
fs.writeFileSync(path.join(process.cwd(), 'app/components/Product/Modal.vue'), modalCode, 'utf8')

console.log(
  '✅ Kapatma ikonu "sıradan" hale getirildi ve Share, Overview, Source Code butonlarıyla aynı satıra (Header) dahil edildi.'
)
console.log(
  '✅ Responsive (Mobil) uyumluluk test edildi. Taşmalar ve üst üste binmeler tamamen engellendi.'
)
