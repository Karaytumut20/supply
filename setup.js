...
const signInCode = `<script setup lang="ts">
import { ref } from 'vue'
...
fs.writeFileSync(path.join(process.cwd(), 'app/pages/sign-in.vue'), signInCode, 'utf8')
console.log('✅ Sign-in sayfasına "Parolayı Göster/Gizle" özelliği başarıyla eklendi.')
